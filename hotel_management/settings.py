...
SECRET_KEY = 'django-insecure--35tto3k(8g)ntdf_q#37*ab2%$!xqfyogkf%%_h!b3z#m9e@8'
...
INSTALLED_APPS = [
    ...
    'widget_tweaks',  # Pour widget_tweaks template tags
    'hotel',  # Notre application de gestion d'hôtel
]
...
# Format de date et heure en français
DATE_FORMAT = 'd/m/Y'
...
MIDDLEWARE = [
    ...
    'hotel.middleware.UserSettingsMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'hotel.context_processors.user_settings',
            ],
        },
    },
]
